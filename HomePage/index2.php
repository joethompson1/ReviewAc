				...
				<div class="search-box">
					<div id="sb-search" class="sb-search">
						<form action="single.php" method='POST'>
							<input class="sb-search-input" placeholder="Enter your search term..." type="text" name="hall">
...
<div class="container">
		  ...
		  <div class=" h_menu4">
				<ul class="memenu skyblue">
				    ...
				    <li class="grid"><a class="color2" href="#">TYPES OF ROOM</a>
					  	<div class="mepanel">
						<div class="row">
							<div class="col1">
								<div class="h_nav">
									<ul>
										<li><a href="products.html">Non-ensuite/shared</a></li>
										<li><a href="products.html">Ensuite/shared</a></li>
										<!--<li><a href="products.html">Collection/Duvet</a></li>
										<li><a href="products.html">Comforter</a></li>
										<li><a href="products.html">Comforter Set</a></li>
										<li><a href="products.html">Decorative Pillow</a></li>
			...
			<ul class="rslides" id="slider">
			    <li>
						...
						<div class="banner-text">
							<h3>Find your perfect student home here   </h3>
	...
	<div class="cont">
		<div class="content">
		  ...
		  <div class="col-md-6 men">
					<a href="single.html" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/Denmark.jpg" alt="">
						<div class="b-wrapper">
				...
				<div class="col-md-6">
					<div class="col-md1 ">
						<a href="single.html" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/George Kenyon.jpg" alt="">
							<div class="b-wrapper">
											<h3 class="b-animate b-from-top top-in1   b-delay03 ">
												<span>GEORAGE KENYOU HALL</span>
											</h3>
										</div>
						</a>
					...
					<div class="col-md2">
						<div class="col-md-6 men1">
							<a href="single.html" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/Liberty Point.jpg" alt="">
									<div class="b-wrapper">
						...
						<div class="col-md-6 men2">
							<a href="single.html" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/Manchester Garden.jpg" alt="">
									<div class="b-wrapper">
											<h3 class="b-animate b-from-top top-in2   b-delay03 ">
												<span>MANCHESTER GARDEN</span>
											</h3>
										</div>
							</a>
